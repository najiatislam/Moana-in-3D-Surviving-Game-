...
def init_game():
    ...
    global game_over, game_won, reloading, reload_start_time, game_start_time
    global arrows, treasures,  trap_zones, water_bottles
...
def main():
    global treasures, animals, arrows, palm_trees, trap_zones

    # Initialize GLUT
    glutInit()
    glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGB | GLUT_DEPTH)
    glutInitWindowSize(1000, 800)
    glutCreateWindow(b"Moana's Adventure")
